...
fn main() {
    ...
    for (i, house) in town.iter().enumerate() {
        match house {
            &House::Vacant => println!("Number {} is available!", i),
            &House::Occupied(_) => println!("Number {} is taken.", i),
        }
    }
    ...
    for (i, house) in town.iter().enumerate() {
        match house {
            &Vacant => println!("Number {} is available!", i),
            &Occupied(ref individual) => println!("Number {} is taken by {:?}", i, individual),
        }
    }
